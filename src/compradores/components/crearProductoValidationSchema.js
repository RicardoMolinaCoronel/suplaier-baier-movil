...
const validationSchema = yup.object().shape({
  name: yup.string().required('El nombre del producto es requerido').min(3,"El nombre no puede ser menor a 3 caracteres")
  ...
  description: yup.string().required('La descripción es requerida').min(5,"La descripción no puede ser menor a 5 caracteres")
