        ...
        <View style={styles.resumenProductoVentana}>
          ...
          <View style={styles.resumenProductoVentanaContenido}>
            <View style={styles.explorarCatTitle}>
              ...
              <Text style={styles.paragraphMid}>
                <b>Cancelar Oferta</b>
              </Text>
            </View>
            ...
            <View style={styles.compraProductoBox}>
              <Text style={styles.paragraph}>
                ¿Está seguro de cancelar la oferta?, los pagos serán devueltos a
                los compradores y podría existir una tarifa de cobro adicional.
              </Text>
            </View>
