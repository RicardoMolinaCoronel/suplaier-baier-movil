...
import {View, Image, StyleSheet, Pressable, TouchableOpacity, Animated} from 'react-native'
import Constants from 'expo-constants'
import StyledText from '../../styles/StyledText'
import theme from '../../theme.js'
import Icon from 'react-native-ico-material-design';

const AppProvBar = ({closeButtonOffset, scaleValue, offsetValue, showMenu, setShowMenu}) =>{
    const iconHeight = 26;
    const iconWidth = 26;
    return (
...
<Animated.View style={{
    ...
    <TouchableOpacity style={styles.iconBehave} onPress={() => {
      // Do Actions Here....
      // Scaling the view...
...
<Icon name={showMenu ? "menu-button" : "menu-button" } height={iconHeight} width={iconWidth} color={theme.bottomBar.iconPrimary}/>
