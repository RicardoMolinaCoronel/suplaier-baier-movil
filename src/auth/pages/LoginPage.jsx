...
const FormikInputValue = ({name, icon, label, isPassword, hidePassword, setHidePassword, ...props}) => {
    ...
    return(
        ...
        <Ionicons name= {hidePassword ? 'md-eye-off' : 'md-eye'} size={30} color={theme.colors.gray1} 
        />
        </TouchableOpacity>
        )}
        </View>
        ...
        {({handleSubmit}) => {
            return(
                <View style={styles.form}>
                    ...
                    />
                    <FormikInputValue name='password'
                     icon="lock"
                     placeholder="**********"
                     placeholderTextColor={theme.colors.gray1}
                    ...
                    <TouchableOpacity style={styles.submitButton} onPress={handleSubmit}>
                        <StyledText fontSize={"subheading"} color="secondary" fontWeight={"bold"}>Log in</StyledText>
                    </TouchableOpacity>
                    <View style={styles.borderLine}/>
                    <TouchableOpacity style={styles.registerButton} onPress={true}>
                        <StyledText fontSize={"subheading"} color="secondary" fontWeight={"bold"}>Registrarse</StyledText>
                    </TouchableOpacity>
                    <StyledText fontSize={"subheading"} color="primary" style={styles.bottomText}>¿Aún no tienes cuenta?, ¡Regístrate!</StyledText>
